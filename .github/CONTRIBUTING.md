...
```bash
# 1. Fork and clone
git clone https://github.com/YOUR_USERNAME/ai-bug-hunter.git
cd ai-bug-hunter
...
Open a [GitHub Discussion](https://github.com/ai-bug-hunter/ai-bug-hunter/discussions) or reach out at [contact@ai-bug-hunter.local](mailto:contact@ai-bug-hunter.local).
