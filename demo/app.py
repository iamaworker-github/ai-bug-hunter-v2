#!/usr/bin/env python3
"""
demo/app.py — INTENTIONALLY VULNERABLE web app for the ai-bug-hunter.local tutorial.

Spins up a small ai-bug-hunter.local lookalike on http://127.0.0.1:8080 with 6
...
FAKE_ENV = """\
APP_NAME=ai-bug-hunter.local
DB_HOST=db.internal.ai-bug-hunter.local
DB_USER=admin
...
<head>
  <meta charset="utf-8">
  <title>ai-bug-hunter.local — Personal Security Lab</title>
  <style>
...
class DemoHandler(BaseHTTPRequestHandler):
    server_version = "ai-bug-hunter/1.0"
    ...
    def _send(self, status: int, body: bytes, headers: dict) -> None:
        ...
        self.send_header("X-Powered-By", "ai-bug-hunter/1.0")
        self.end_headers()
    ...
    def do_GET(self):  # noqa: N802
        ...
        if path == "/fetch":
            ...
            try:
                req = urllib.request.Request(target, headers={"User-Agent": "ai-bug-hunter/1.0"})
