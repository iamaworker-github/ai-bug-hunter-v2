#!/bin/bash
# AI Bug Hunter v2 — install skills, commands, and agents for multiple harnesses.
...
Standalone (no subscription needed):
  ./install.sh --agent standalone Install 'ai-bug-hunter-v2' system command
                                  After install, type from anywhere:
                                    ai-bug-hunter-v2 help
                                    ai-bug-hunter-v2 setup
                                    ai-bug-hunter-v2 recon target.com
                                    ai-bug-hunter-v2 h target.com
...
install_standalone() {
    echo ""
    echo "════════════════════════════════════════════════════"
    echo "  AI Bug Hunter v2 Standalone Engine (no subscription)"
    echo "  33 vuln classes · BACK-ME-UP · Zen API · MCP"
    echo "════════════════════════════════════════════════════"
    echo ""
    ...
    # ── Install ai-bug-hunter system command ──────────────────────────────────────
    ...
    SUDO="${SUDO:-}"
    TARGET="$BIN_DIR/ai-bug-hunter-v2"
    ...
    echo ""
    echo "    ai-bug-hunter-v2 setup"
    echo "    ai-bug-hunter-v2 recon target.com"
    echo "    ai-bug-hunter-v2 hunt  target.com"
    echo "    ai-bug-hunter-v2 validate \"<finding>\""
    echo "    ai-bug-hunter-v2 chat"
    echo "════════════════════════════════════════════════════"
    echo ""
}
