...
def _print_quick_help():
    ...
    AI Bug Hunter — fast commands

    ai-bug-hunter help                 Show full help
    ai-bug-hunter setup                Configure your AI provider
    ai-bug-hunter recon target.com     Map the attack surface
    ai-bug-hunter hunt target.com      Run the full hunt pipeline
    ai-bug-hunter validate "finding"   Run the 7-Question Gate
    ai-bug-hunter report               Write a submission-ready report
    ai-bug-hunter status               Show pipeline status
